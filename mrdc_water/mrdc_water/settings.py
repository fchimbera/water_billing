"""
Django settings for mrdc_water project.
...
SECRET_KEY = 'django-insecure-gg&yeffx7cv+%2%%0j0fry!ljx)$fq(cqvj0(h3^*a4rru@sx9'
...
WSGI_APPLICATION = 'mrdc_water.wsgi.application'
